...
- ✨ **우선순위 관리**: 1~5단계의 우선순위를 설정하고 자동으로 정렬
- 📅 **마감일 설정**: 업무의 마감일을 설정하고 기한 경과 여부 표시
- ✅ **완료 상태 관리**: 완료된 업무를 별도 섹션에서 관리
- 📱 **반응형 디자인**: PC, 태블릿, 모바일 모든 기기에서 완벽 작동
- ☁️ **클라우드 동기화**: Supabase를 통한 실시간 데이터 동기화
...
- **헤더**: 그라데이션 배경의 깔끔한 디자인
- **폰트**: 맑은 고딕 (Malgun Gothic)
- **색상**: 우선순위별로 다른 색상으로 시각화
- **레이아웃**: 모바일 최적화된 반응형 디자인
